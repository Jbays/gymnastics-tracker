  ...
  <div class="hello">
    ...
    <div v-if='!submittedStretchRoutine'>
      ...
      <div v-if='fetchTodaysWorkout' >
        ...
        <div class='display-exercise'>
          exercise name: {{todaysWorkout[17].exercise_name}}
          <label class='emoji-feedback true'>😀</label><label class='emoji-feedback false'>😐</label>
          <br>
          standard: {{todaysWorkout[17].standard}}
        </div>
        <div class='display-exercise'>
          exercise name: {{todaysWorkout[18].exercise_name}}
          <label class='emoji-feedback true'>😀</label><label class='emoji-feedback false'>😐</label>
          <br>
          standard: {{todaysWorkout[18].standard}}
        </div>
        <div class='display-exercise'>
          exercise name: {{todaysWorkout[19].exercise_name}}
          <label class='emoji-feedback true'>😀</label><label class='emoji-feedback false'>😐</label>
          <br>
          standard: {{todaysWorkout[19].standard}}
        </div>
        <div class='display-exercise'>
          exercise name: {{todaysWorkout[20].exercise_name}}
          <label class='emoji-feedback true'>😀</label><label class='emoji-feedback false'>😐</label>
          <br>
          standard: {{todaysWorkout[20].standard}}
        </div>
        <div class='display-exercise'>
          exercise name: {{todaysWorkout[21].exercise_name}}
          <label class='emoji-feedback true'>😀</label><label class='emoji-feedback false'>😐</label>
          <br>
          standard: {{todaysWorkout[21].standard}}
        </div>
        <div class='display-exercise'>
          exercise name: {{todaysWorkout[22].exercise_name}}
          <label class='emoji-feedback true'>😀</label><label class='emoji-feedback false'>😐</label>
          <br>
          standard: {{todaysWorkout[22].standard}}
        </div>
      </div>
